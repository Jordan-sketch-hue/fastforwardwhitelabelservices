      ...
      <section className="relative bg-gradient-to-b from-purple-50 to-white pt-20 pb-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96 lg:h-full bg-gradient-to-br from-purple-100 to-orange-100 rounded-2xl flex items-center justify-center overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-purple-200/40 to-orange-200/40 backdrop-blur-3xl" />
              <div className="relative z-10 text-center">
                ...
                <p className="text-sm text-gray-500">Real-time package tracking & management</p>
              </div>
            </div>
          </div>
